    ...
    <div class="content">
      ...
      <div class="info-grid">
        <div class="info-card">
          ...
          <div class="info-value">${profile?.full_name || user?.full_name || "N/A"}</div>
        </div>
        <div class="info-card">
        ...
        <div class="info-card">
          ...
          <div class="info-value">${profile?.college_name || "N/A"}</div>
        </div>
        <div class="info-card" style="grid-column: span 2;">
          <div class="info-label">Order Details</div>
          <div class="info-value" style="font-size: 12px; font-weight: 500; color: #475569; line-height: 1.4;">
            Order ID: ${pay.razorpay_order_id || "N/A"}<br/>
            Payment ID: ${pay.razorpay_payment_id || "N/A"}
          </div>
        </div>
      </div>
