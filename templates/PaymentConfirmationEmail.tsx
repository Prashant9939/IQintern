...
export function getPaymentConfirmationEmailHtml(fullName: string, amount: number, orderId: string, internshipTitle: string): string {
  const content = `
    ...
    <div style="text-align: center; margin: 30px 0;">
      <a href="${BRANDING.websiteUrl}/student/payment" target="_blank" rel="noopener noreferrer" style="background-color: #4F46E5; color: #FFFFFF; text-decoration: none; padding: 12px 28px; border-radius: 9999px; font-size: 14px; font-weight: 600; display: inline-block;">
