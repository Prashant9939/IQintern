...
export function getWelcomeEmailHtml(fullName: string): string {
  const content = `
    <h2 style="color: #1E293B; margin: 0 0 20px 0; font-size: 22px; font-weight: 700;">Welcome to ${BRANDING.name}!</h2>
    ...
    <p style="font-size: 15px; color: #475569; margin: 0 0 25px 0;">
      Thank you for registering with ${BRANDING.name}. Your account has been created successfully.
    </p>
